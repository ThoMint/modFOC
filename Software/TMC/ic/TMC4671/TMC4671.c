...
{
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_POLARITIES, TMC4671_PWM_POLARITIES_0_MASK, TMC4671_PWM_POLARITIES_0_SHIFT, lowSideGC);
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_POLARITIES, TMC4671_PWM_POLARITIES_1_MASK, TMC4671_PWM_POLARITIES_1_SHIFT, highSideGC);
}

void tmc4671_setPWMFreq(uint8_t motor, uint32_t freq)
{
	tmc4671_writeInt(motor, TMC4671_PWM_MAXCNT, ((TMC4671_CORE_CLK/freq)-1));
}

void tmc4671_setPWMBBM(uint8_t motor, uint8_t lowSideBBM, uint8_t highSideBBM)
{
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_BBM_H_BBM_L, TMC4671_PWM_BBM_L_MASK, TMC4671_PWM_BBM_L_SHIFT, lowSideBBM);
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_BBM_H_BBM_L, TMC4671_PWM_BBM_H_MASK, TMC4671_PWM_BBM_H_SHIFT, highSideBBM);
}

void tmc4671_setPWMMode(uint8_t motor, uint8_t pwmMode, uint8_t spaceVectorPWM)
{
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_SV_CHOP, TMC4671_PWM_CHOP_MASK, TMC4671_PWM_CHOP_SHIFT, pwmMode);
	TMC4671_FIELD_UPDATE(motor, TMC4671_PWM_SV_CHOP, TMC4671_PWM_SV_MASK, TMC4671_PWM_SV_SHIFT, spaceVectorPWM);
}
